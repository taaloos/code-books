<?php
/**
 * Exemplo para utilização do método incluir() da classe base
 */
...
$_t->getCampo('DESCRICAO')->setValor('Teste de Inclusão');
$_t->getCampo('VALOR')->setValor('135,57');
if($_t->incluir()===false) {
	die("Erro na Inclusão..{$_t->getConn()->getUltimoErro()}");
}
