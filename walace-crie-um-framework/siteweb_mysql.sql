...
INSERT INTO `menu` (`menu_id`,`menu_desc`,`menu_prog`,`menu_icon`,`menu_pai`) VALUES 
 (2,'Administração','[menu]','',-1),
...
INSERT INTO `permissao` (`usuario_id`,`menu_id`,`permissao_modo`) VALUES 
 (1,5,'NEG'),
 (1,6,'NEG'),
 (1,7,'AUT'),
 (1,13,'NEG'),
...
INSERT INTO `usuario` (`usuario_id`,`usuario_nome`,`usuario_login`,`usuario_senha`,`usuario_email`,`usuario_ativo`) VALUES 
