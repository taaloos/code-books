...
Array(new atributo("SRC","framework/javascript/ajax.js"))));
$_main->getLastSubTag()->addSubTag(new tag($_tipos->getTipo("SCRIPT"),
Array(new atributo("SRC","framework/javascript/processaajax.js"))));
$_main->getLastSubTag()->addSubTag(new tag($_tipos->getTipo("SCRIPT"),
Array(new atributo("SRC","framework/javascript/funcoesgenericas.js"))));
...
"ObjProcAjax.run('exemplo_5_1.php5','CORPO');")),
"Exemplo 5_1"));
// Corpo
$_main->getLastSubTag()->addSubTag(new tag($_tipos->getTipo("DIV"),
