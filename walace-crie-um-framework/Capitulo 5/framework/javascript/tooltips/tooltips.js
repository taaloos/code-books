...
Tooltip.prototype = {
	...
	setup: function(){
		...
		this.tooltip.style.left = this.xCord + 'px';//- 7 + "px";
		if(this.options.fixTop===false) {
			this.tooltip.style.top = this.yCord + 19 + "px";
		} else {
			this.tooltip.style.top = this.options.fixTop + "px";
		}
	},
