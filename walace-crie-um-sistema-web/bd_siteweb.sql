...
-- Started on 2009-07-14 20:21:34
...
--
-- TOC entry 1774 (class 1262 OID 16385)
-- Name: siteweb; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE siteweb WITH TEMPLATE = template0 ENCODING = 'SQL_ASCII';


ALTER DATABASE siteweb OWNER TO postgres;
...
-- Dependencies: 1752 6
-- Name: tab_teste; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--
...
ALTER TABLE public.tab_teste OWNER TO postgres;
...
-- Name: chv_login; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
-- Name: favoritos_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
-- Name: tab_teste_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--
...
-- Completed on 2009-07-14 20:21:34
